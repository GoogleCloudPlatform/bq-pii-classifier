...
import com.google.cloud.pso.bq_pii_classifier.functions.dispatcher.gcs.GcsDispatcherConfig;
...
public class Environment {
    ...
    public GcsDispatcherConfig toConfig(){

        return new GcsDispatcherConfig(
                getProjectId(),
                getComputeRegionId(),
                getDataRegionId(),
                getDlpConfigParent(),
