...
resource "google_bigquery_table" "logging_view_tag_history" {
  ...
  view {
    ...
    query = templatefile("../../modules/terraform_04_annotations_infra/stacks/bq-discovery-stack/views/v_log_tag_history.tpl",
      {
        project = var.publishing_project
...
resource "google_bigquery_table" "logging_view_label_history" {
  ...
  view {
    use_legacy_sql = false
    query = templatefile("../../modules/terraform_04_annotations_infra/stacks/bq-discovery-stack/views/v_log_label_history.tpl",
      {
        project = var.publishing_project
        dataset = var.logging_dataset_name
        logging_table = var.logging_table_name
...
resource "google_bigquery_table" "view_tagging_actions" {
  ...
  view {
    use_legacy_sql = false
    query = templatefile("../../modules/terraform_04_annotations_infra/stacks/bq-discovery-stack/views/v_tagging_actions.tpl",
      {
        project = var.publishing_project
        dataset = var.logging_dataset_name
...
resource "google_bigquery_table" "view_run_summary_counts" {
  ...
  view {
    use_legacy_sql = false
    query = templatefile("../../modules/terraform_04_annotations_infra/stacks/bq-discovery-stack/views/v_run_summary_counts.tpl",
      {
        project = var.publishing_project
        dataset = var.logging_dataset_name
...
resource "google_bigquery_table" "dispatcher_runs_bq_table" {
  ...
  schema = file("../../modules/terraform_04_annotations_infra/stacks/bq-discovery-stack/schema/dispatcher_runs_bigquery.json")
