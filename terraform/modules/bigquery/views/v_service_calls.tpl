...
SUM(CASE WHEN step = 'START'  AND function_number = 3 THEN 1 ELSE 0 END) AS listener_starts,
SUM(CASE WHEN step = 'END' AND function_number = 3 THEN 1 ELSE 0 END) AS listener_ends,
