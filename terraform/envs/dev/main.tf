...
module "annotations-solution" {
  ...
  classification_taxonomy = [
    ...
    },
    {
      ...
      labels = [{ key = "dg_data_category_health", value = "yes" }], taxonomy_number = 1, 
    },
    {
    ...
    },
    {
      ...
      classification                                                               = "SPII",
      labels = [{ key = "dg_data_category_spii", value = "yes" }], taxonomy_number = 2, 
    },
    {
    ...
    },
    {
      ...
      labels = [{ key = "uncategorized", value = "yes" }], taxonomy_number = 1, 
    },
    {
