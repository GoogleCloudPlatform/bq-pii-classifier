...
WITH a AS (
    ...
    WHERE
        ...
        (REGEXP_CONTAINS(CAST(file_store_profile.config_snapshot.discovery_config.org_config.location.folder_id AS STRING), r'${folder_id_regex}') OR file_store_profile.config_snapshot.discovery_config.org_config.location.folder_id IS NULL)
    GROUP BY 1,2,3,4
    HAVING
