...
/** Enum to represent the action to be performed on a column regarding policy tags. */
public enum ColumnTaggingAction {
  ...
  // e.g. previous run detected as STREET_ADDRESS and now as PERSON_NAME (across solution-managed
  // taxonomies)
  OVERWRITE,
