...
public class LoggingHelper {
  ...
  public void logNonRetryableExceptions(String trackingId, String entityId, Exception ex) {
    ...
    logWithTracker(
        ...
        entityId,
        String.format(
            "Caught a Non-Retryable exception while processing tracker `%s`. Exception: %s. Msg: %s",
  ...
  public void logRetryableExceptions(
    ...
    logWithTracker(
        ...
        entityId,
        String.format(
            "Caught a Retryable exception while processing tracker `%s`. Exception: %s. Msg: %s. Classification Reason: %s.",
