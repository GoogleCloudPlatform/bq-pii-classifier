...
public class LabelsHelper {
    ...
    public static Map<Map.Entry<String, String>, ResourceLabelingAction> computeLabelsActions(Map<String, String> existingLabels, Map<String, String> newLabels, String existingLabelsRegex){
    ...
    public static Map<String, String> removeToBeDeletedLabels(Map<Map.Entry<String, String>, ResourceLabelingAction> labelsWithAction){
